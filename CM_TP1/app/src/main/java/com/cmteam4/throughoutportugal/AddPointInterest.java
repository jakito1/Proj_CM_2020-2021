...
public class AddPointInterest extends AppCompatActivity implements OnMapReadyCallback, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        var = variables;
        if (variables.getDouble("CHOOSE_LATITUTE") != 0.0 || variables.getDouble("CHOOSE_LONGITUTE") != 0.0) {
            manualLoc = true;
            txtLatitude.setText(String.valueOf(variables.getDouble("CHOOSE_LATITUTE")));
            txtLongitude.setText(String.valueOf(variables.getDouble("CHOOSE_LONGITUTE")));
        }
        ...
        btnTakePhoto.setOnClickListener(v -> {
            if (getApplicationContext().getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA_ANY)) { //VALIDA SE O TLM DO UTILIZADOR TEM CAMERA OU NAO
    ...
    public void onMapReady(@NotNull GoogleMap googleMap) {
        ...
        if (manualLoc) {
            Log.e("ENTROO", "MANUEALLLL LOC");
            LatLng currLoc = new LatLng(var.getDouble("CHOOSE_LATITUTE"), var.getDouble("CHOOSE_LONGITUTE"));
            //LatLng currLoc = new LatLng(customLatitude, customLongitude);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == CAMERA_CODE) {
            ...
            Log.e("HUHUHU", "ENTREEEIIII 2222222222222222");
        }
    }
