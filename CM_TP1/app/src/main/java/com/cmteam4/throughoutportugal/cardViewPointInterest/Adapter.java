...
import com.cmteam4.throughoutportugal.pointInterest.MapPoint;
...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (pointOfInterest.getImgPoint() != null) {
            ...
            storageReference.getDownloadUrl().addOnSuccessListener(uri -> Picasso.get().load(uri).into(holder.imageView));
        } else {
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            intent.putExtra("LATITUDE", pointOfInterest.getLatitude());
            intent.putExtra("LONGITUDE", pointOfInterest.getLongitude());
